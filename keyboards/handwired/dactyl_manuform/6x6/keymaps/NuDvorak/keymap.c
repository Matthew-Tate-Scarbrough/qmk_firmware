...
// │      │      │      │      │      │      │                                │      │      │      │      │      │      │
// └──────┴──────┼──────┼──────╆━━━━━━╈━━━━━━╈━━━━━━┳━━━━━━┓    ┏━━━━━━┳━━━━━━╈━━━━━━╈━━━━━━╅──────┼──────┼──────┴──────┘
//               │ ←    │ →    ┃ TAB  ┃SPACE ┃ CTRL ┃SHIFT ┃    ┃ LEFT ┃RETURN┃ALT-GR┃BACK  ┃ ↓    │ ↑    │
//               │      │      ┃      ┃      ┃      ┃      ┃    ┃ META ┃      ┃      ┃ SPACE┃      │      │
//               │      │      ┃      ┃      ┃      ┃      ┃    ┃      ┃      ┃      ┃      ┃      │      │
//               └──────┴──────┺━━━━━━┻━━━━━━╋━━━━━━╋━━━━━━┫    ┣━━━━━━╋━━━━━━╋━━━━━━┻━━━━━━┹──────┴──────┘
//                                           ┃RAISE ┃ ALT  ┃    ┃DELETE┃LOWER ┃                                     
//                                           ┃      ┃      ┃    ┃      ┃      ┃                                     
//                                           ┃      ┃      ┃    ┃      ┃      ┃                                     
//                                           ┗━━━━━━┻━━━━━━┛    ┗━━━━━━┻━━━━━━┛                                     
 	...
 	[_DVORAK] = LAYOUT_6x6(
      ...
      //-------------------------------------|========|------------|* | *|----------|========|--------------------------------------||
        ...
        KC_LBRC  , KC_SCLN, KC_Q   , KC_J    , KC_K   , KC_X   ,   /* | */   KC_B   , KC_M   , KC_W   , KC_V  , KC_Z  , KC_RBRC,
                          ...
                          //-----------------|=====================|* | *|===================|------------------||
                                                                   /* | */  
                            KC_LEFT, KC_RIGHT, KC_TAB , KC_SPC ,   /* | */   KC_ALGR, KC_BSPC, KC_DOWN, KC_UP ,
                                                                   /* | */  
                          //-----------------|=====================|* | *|===================|------------------||
                                                                   /* | */  
                                               KC_LCTL, KC_LSFT,   /* | */   KC_LWIN, KC_ENT,
                                                                   /* | */  
                                             //--------------------|* | *|--------------------//
                                                                   /* | */  
                                               RAISE  , KC_LALT,   /* | */   KC_DEL , LOWER
                                                                   /* | */
 	),
 	...
 	[_LOWER] = LAYOUT_6x6(
      ...
      //-------------------------------------|========|------------|* | *|----------|========|--------------------------------------||
                                                                   /* | */  
        _______  , KC_HOME, KC_PGDN,  KC_PGUP,  KC_END,  KC_INS,   /* | */   KC_PEQL, KC_P4  , KC_P5  , KC_P6 ,KC_PPLS, _______,
                                                                   /* | */  
      //-------------------------------------|========|------------|* | *|----------|========|--------------------------------------||
                                                                   /* | */  
